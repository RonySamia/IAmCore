...
public class ConsoleLauncher {
	...
	public static void main(String[] args) {
		...
		case "b":
			//Modify
			CreateActivity.modifyUser(scanner);
			break;
			
		case "c":
			//Delete
			CreateActivity.deleteUser(scanner);
			break;
	 ...
	 * @param scanner
	 */
	private static void end(Scanner scanner) {	//message displayed when the app is closed
	 ...
	 * @param scanner
	 */
	private static boolean authenticate(Scanner scanner) {  //authentication method
